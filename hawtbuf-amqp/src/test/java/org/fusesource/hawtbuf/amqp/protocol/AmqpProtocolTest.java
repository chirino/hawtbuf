...
import org.fusesource.hawtbuf.amqp.protocol.types.*;
import org.fusesource.hawtbuf.amqp.protocol.types.TypeFactory;
import static org.fusesource.hawtbuf.amqp.protocol.types.TypeFactory.*;
...
public class AmqpProtocolTest extends TestCase {
    ...
    private <T extends AmqpType<?, ?>> T marshalUnmarshal(T type) throws IOException, AmqpEncodingError {
        ...
        AmqpMarshaller marshaller = org.fusesource.hawtbuf.amqp.protocol.marshaller.v1_0_0.AmqpMarshaller.getMarshaller();
